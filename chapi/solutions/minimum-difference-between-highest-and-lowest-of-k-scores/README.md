...
Please see the [original problem description](https://leetcode.com/problems/minimum-difference-between-highest-and-lowest-of-k-scores/).
...
You can find the solution [here](./minimum-difference-between-highest-and-lowest-of-k-scores.py).
