...
Please see the [original problem description](https://leetcode.com/problems/compare-version-numbers/).
...
You can find the solution [here](./compare-version-numbers.py).
